...
import br.ultimate_restfull.exception.UnsuportedMathOperationException;
...
//                request.getDescription(false)
    ...
    public final ResponseEntity<ExceptionHandler> handleBadExceptions(Exception ex, WebRequest request) {
        ExceptionResponse response = new ExceptionResponse(
                new Date(),
                ex.getMessage()
//                request.getDescription(false)
